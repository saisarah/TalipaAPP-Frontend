...
<Page>
  <PageHeader title="Why can't i return my order?">
    ...
    <div className="">
      <p>
        1. You have already confirmed the receipt of your order by click the{" "}
        <b>"Order Received" button.</b>
      </p>
      <p>
        2. The item is already beyond the money-back guarantee period (4 days)
      </p>
      <p>
    ...
    <div className="">
      ...
      <p>
        2. Contact the seller to discuss the other possible options. To learn
        how to chat with the seller, click{" "}
