  ...
  return (
    <Page>
      <PageHeader title="How do i track my order?">
        <div className="">
          <p>
            You can check the status of your orders via My Purchases in the Me
            tab on TalipaAPP App.
          </p>
        </div>
        ...
        <div className="">
          ...
          <p>
            <b>To Ship</b> - contains paid, scheduled, and ready for pick-up
            orders
          </p>
          <p>
        ...
        <div className="">
          ...
          <p>
            Once your order is under the <b>To Ship</b> or <b>To Receive</b>{" "}
        ...
        <div className="">
          ...
          <p>
            ...
            updated yet. Kindly wait <b>within 24 - 48 hours</b> for the courier
