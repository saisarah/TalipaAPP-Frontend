    ...
    <Page className="bg-white text-black md:m-3 md:shadow">
      <div className="flex flex-col justify-center p-4 text-center">
        ...
        <div className="flex w-full justify-center p-4 text-center">
          <div className=" leading-4">
            ...
            <span className="text-slate-500">{user.user_type}</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-2 px-4">
        ...
        >
          <div>
            Contact Number
            <div className="text-slate-400">{user.contact_number}</div>
          </div>
          <div>
            <RightOutlined />
          </div>
        ...
        >
          <div>
            Gender
            <div className="text-slate-400">{user.gender}</div>
          </div>
          <div>
            <RightOutlined />
          </div>
        ...
        <Link
          className="  mb-3 flex w-full items-center justify-between border-b-2 "
          to="/farmer/settings/change-name"
        >
          <div>
            Delivery Address
        ...
        <Link className="mb-3 flex  flex-col justify-center border-b-2" to="">
          <div className="text-left">Store Validation</div>
