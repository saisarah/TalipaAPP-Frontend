...
export default function VendorPageHeader({ title, left, back, onBack }) {
  ...
  return (
    <div className="sticky top-0 z-[15] right-0 left-0 grid h-16 flex-shrink-0 grid-cols-12 items-center bg-white px-4 shadow-sm lg:flex lg:justify-between lg:fixed lg:pl-[316px]">
